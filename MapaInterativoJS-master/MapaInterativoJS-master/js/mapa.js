...
dicEstados = {
  ...
  unidades = {
    'Rio de Janeiro': 
    {
      ...
      {
        'Title' : '',
        'Text' : 'Uma excelente escolha. Cidade maravilhosa e cheia de encantos',
        'Endereco' : ''
      },
    },
    'Acre': 
...
function drawRegionsMap() {
  ...
  var options = {
     ...
     datalessRegionColor: 'CAE8F2',
     defaultColor: '#00248E',
     width: 500,
     tooltip: {trigger: 'selection'},
     tooltip: {textStyle: {color: '#00248E',
      fontName: 'Tenda',
      fontSize: 12,    
    }, showColorCode: true},
    ...
    if (message == '') {
      ...
      for(var i = 0; i < Object.keys(unidades).length; i ++){ 
        ...
        if(unidades[dicEstados[message]][i] != undefined){
          document.getElementById("dadosLojas").innerHTML += 
          unidades[dicEstados[message]][i]['Title'] + 
          unidades[dicEstados[message]][i]['Text'] 
        }             
      }
    }
